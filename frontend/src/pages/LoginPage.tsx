  ...
  return (
    <div className="login-wrap">
      ...
      <form className="login-card glass" onSubmit={handleSubmit}>
        ...
        {/* Сказать, сколько держится вход, здесь — единственный момент, когда
            это и уместно, и полезно: иначе повторный PIN выглядит как то, что
            приложение забыло прошлый вход просто так. */}
        {expired && !error && (
          <div className="notice">
            Вход действует сутки — прошлый уже закончился. Введите PIN-код ещё раз.
          </div>
        )}
